    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                ...
                try {
                    // Base64 encoded - com.android.vending.licensing.ILicensingService
                    // Consider encoding this in another way in your code to improve security

                    // As of Android 5.0, implicit Service Intents are no longer
                    // allowed because it's not possible for the user to participate in disambiguating them. This does mean we break
                    // compatibility with Android Cupcake devices with this release, since setPackage was added in Donut.
                    String action = new String(Base64.decode("Y29tLmFuZHJvaWQudmVuZGluZy5saWNlbnNpbmcuSUxpY2Vuc2luZ1NlcnZpY2U="));

                    // Base64 encoded - com.android.vending
                    String packageNm = new String(Base64.decode("Y29tLmFuZHJvaWQudmVuZGluZw=="));

                    boolean bindResult = mContext.bindService(
                            new Intent(action).setPackage(packageNm)
                            , this
